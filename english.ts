export default {
    commands: {
        ...
        flip: {
            ...
            response: (head: number, tails: number) => `You got **${head}** head and **${tails}** tails out of **${head + tails}** flip(s)!`,
            options: {
                times: {
                    name: 'times',
                    description: 'The amount of times you want to flip the coin',
                    limit: "You can't flip more than **100** times!",
                },
            },
        },
        rps: {
    ...
    interactions: {
        errors: {
            ...
            notFoundOrUnknown: 'Either command was not found or an unknown error occured!',
            noDMs: 'Interactions are not available in DMs',
        },
